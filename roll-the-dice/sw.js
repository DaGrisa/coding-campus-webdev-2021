...
const BASE_CACHE_FILES = ["/index.css", "/index.js", "/manifest.webmanifest"];

const OFFLINE_CACHE_FILES = ["/index.css", "/index.js", "/index.html"];

const NOT_FOUND_CACHE_FILES = ["/index.css", "/index.js"];
